...
4. Dissecting contextual word embeddings: architecture and representation, Peters et al., 2018 [[Paper](https://arxiv.org/abs/1808.08949)] [[Notes](2018/1808.08949.md)] [\#nlp](#nlp) [\#embeddings](#embeddings)
5. BERT: Pre-training of deep bidirectional transformers for language understanding, Devlin et al., 2018 [[Paper](https://arxiv.org/abs/1810.04805)] [[Notes](2018/1810.04805.md)] [\#nlp](#nlp) [\#embeddings](#embeddings)
6. Learning Semantic Representations for Novel Words: Leveraging Both Form and Context, Schick et al., 2018 [[Paper](https://arxiv.org/abs/1811.03866)] [[Notes](2018/1811.03866.md)] [\#nlp](#nlp) [\#embeddings](#embeddings)
7. Wikipedia2Vec: An Efficient Toolkit for Learning and Visualizing the Embeddings of Words and Entities from Wikipedia, Yamada et al., 2018 [[Paper](https://arxiv.org/abs/1812.06280)] [[Notes](2018/1812.06280.md)] [\#nlp](#nlp) [\#embeddings](#embeddings)
8. Rare Words: A Major Problem for Contextualized Embeddings and How to Fix it by Attentive Mimicking, Schick et al., 2019 [[Paper](https://www.aclweb.org/anthology/N19-1048/)] [[Notes](2019/1906.1048.md)] [\#nlp](#nlp) [\#embeddings](#embeddings)
